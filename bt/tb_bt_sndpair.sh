...
set EXPECT_CHECKMSG_ARG1_INVALID_INPUT "---:${EXPECT_FG_YELLOW}CHECK${EXPECT_NOCOLOR}:->MAC-ADDRESS (${EXPECT_FG_LIGHTPINK}arg1${EXPECT_NOCOLOR}): ${EXPECT_FG_LIGHTRED}INVALID${EXPECT_NOCOLOR} INPUT (e.g., AA:BB:CC:DD:EE:FF)"
set EXPECT_CHECKMSG_ARG2_NOT_A_NUMERIC_VALUE "---:${EXPECT_FG_YELLOW}CHECK${EXPECT_NOCOLOR}:->PIN-CODE (${EXPECT_FG_LIGHTPINK}arg2${EXPECT_NOCOLOR}): ${EXPECT_FG_LIGHTRED}NOT${EXPECT_NOCOLOR} A NUMERIC VALUE"
set EXPECT_CHECKMSG_ARG3_VALUE_CAN_NOT_BE_ZERO "---:${EXPECT_FG_YELLOW}CHECK${EXPECT_NOCOLOR}:->SCAN-TIMEOUT (${EXPECT_FG_LIGHTPINK}arg3${EXPECT_NOCOLOR}): CAN ${EXPECT_FG_LIGHTRED}NOT${EXPECT_NOCOLOR} BE '${EXPECT_FG_LIGHTGREY}0${EXPECT_NOCOLOR}' (e.g., 1 - 255)"
set EXPECT_CHECKMSG_ARG3_CAN_NOT_BE_GREATER_THAN_255 "---:${EXPECT_FG_YELLOW}CHECK${EXPECT_NOCOLOR}:->SCAN-TIMEOUT (${EXPECT_FG_LIGHTPINK}arg3${EXPECT_NOCOLOR}): CAN ${EXPECT_FG_LIGHTRED}NOT${EXPECT_NOCOLOR} BE GREATER THAN '${EXPECT_FG_LIGHTGREY}255${EXPECT_NOCOLOR}' (e.g., 1 - 255)"
