...
CHECK_FAILEDTOENABLE="FAILED TO ENABLE"
CHECK_NOTAVAILABLE="N/A"
CHECK_RUNNING="RUNNING"
CHECK_UNABLETOSTART="UNABLE TO START"
...
PRINTF_USAGE_DESCRIPTION="Utility to Pair & Bind Bluetooth devices to rfcomm."
