...
typedef enum {
  ...
  //SPI
  PMUX_PERIHERAL_PIN_FUNC_SPI_PIN_INT,
  PMUX_PERIHERAL_PIN_FUNC_SPI_PIN_CLK,
  PMUX_PERIHERAL_PIN_FUNC_SPI_PIN_EN,
  PMUX_PERIHERAL_PIN_FUNC_SPI_PIN_MOSI,
  PMUX_PERIHERAL_PIN_FUNC_SPI_PIN_MISO,
